[![Run juicer tests](https://github.com/WindhoverLabs/msg_def_overrides/actions/workflows/ci.yaml/badge.svg)](https://github.com/WindhoverLabs/msg_def_overrides/actions/workflows/ci.yaml)
